 ...
 * streaming API". That surface is now two native plugins: `LiveStream` (camera, encoder, RTMP) and
 * `LivetapSecureStore` (the Keystore-backed vault behind `installVaultBridge`).
 */
export {
  installVaultBridge,
  LiveStream,
