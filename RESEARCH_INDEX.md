...
| Artifact | Status | Owner team |
|---|---|---|
| docs/research/COMPETITOR_FAILURE_DATABASE_A.md (OBS, Streamlabs, Restream, StreamYard, Riverside, Ecamm, Twitch Studio) | DONE (500 lines, 66 rows) | Competitor Research A |
| docs/research/COMPETITOR_FAILURE_DATABASE_B.md (vMix, Wirecast, Lightstream, Prism, Meld, XSplit, YT/TikTok/IG/FB native tools, segments) | DONE (848 lines, 62 rows) | Competitor Research B |
...
| docs/design/DESIGN_SYSTEM.md, docs/design/PRODUCT_SPEC.md | IN PROGRESS | UX / Product Design |
